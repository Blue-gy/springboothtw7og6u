...
export default {
	...
	methods:{
		...
		wordclouds(wordcloudData,echartsId) {
			...
			this.myChart0 = this.$this.$echarts.init(document.getElementById(echartsId));
        ...
        var caiwuqingkuangChart1 = this.$this.$echarts.init(document.getElementById("caiwuqingkuangChart1"),'macarons');
        this.$http({
    ...
    caiwuqingkuangChat2() {
      this.$nextTick(()=>{
        ...
        var caiwuqingkuangChart2 = this.$this.$echarts.init(document.getElementById("caiwuqingkuangChart2"),'macarons');
        this.$http({
    ...
    caiwuqingkuangChat3() {
      this.$nextTick(()=>{
        ...
        var caiwuqingkuangChart3 = this.$this.$echarts.init(document.getElementById("caiwuqingkuangChart3"),'macarons');
        this.$http({
    ...
    caiwuqingkuangChat4() {
      this.$nextTick(()=>{
        ...
        var caiwuqingkuangChart4 = this.$this.$echarts.init(document.getElementById("caiwuqingkuangChart4"),'macarons');
        this.$http({
