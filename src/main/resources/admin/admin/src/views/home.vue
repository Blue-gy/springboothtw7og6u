...
<div class="content" :style='{"minHeight":"100vh","width":"100%","padding":"30px","background":"rgb(255, 255, 255)","height":"auto"}'>
	...
	<div :style='{"margin":"0 0 20px 0","alignItems":"center","justifyContent":"center","display":"flex"}'>
		<div :style='{"border":"2px solid #cdd4de","padding":"5px 0","margin":"0 10px","borderRadius":"40px","display":"flex"}' v-if="isAuth('caiwuqingkuang','首页总数')">
			...
			<div :style='{"width":"160px","alignItems":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"20px","color":"#8d9cb5","fontWeight":"bold","height":"24px"}'>{{caiwuqingkuangCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"16px","color":"#8d9cb5","height":"24px"}'>财务情况总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<div class="type4" :style='{"alignContent":"flex-start","padding":"10px 20px","flexWrap":"wrap","background":"rebeccapurple","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto"}'>
		<div id="caiwuqingkuangChart1" class="echarts1" v-if="isAuth('caiwuqingkuang','首页统计')"></div>
		<div id="caiwuqingkuangChart2" class="echarts2" v-if="isAuth('caiwuqingkuang','首页统计')"></div>
		<div id="caiwuqingkuangChart3" class="echarts3" v-if="isAuth('caiwuqingkuang','首页统计')"></div>
		<div id="caiwuqingkuangChart4" class="echarts4" v-if="isAuth('caiwuqingkuang','首页统计')"></div>
	</div>
</div>
</template>
<script>
...
export default {
	...
	mounted(){
		this.init();
		this.getcaiwuqingkuangCount();
		this.caiwuqingkuangChat1();
		this.caiwuqingkuangChat2();
		this.caiwuqingkuangChat3();
		this.caiwuqingkuangChat4();
	},
	methods:{
		// 词云
		...
		getcaiwuqingkuangCount() {
			this.$http({
				url: `caiwuqingkuang/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.caiwuqingkuangCount = data.data
				}
			})
		},
		caiwuqingkuangChat1() {
        ...
        var caiwuqingkuangChart1 = echarts.init(document.getElementById("caiwuqingkuangChart1"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                caiwuqingkuangChart1.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    caiwuqingkuangChart1.resize();
                };
            }
        });
      })
    ...
    caiwuqingkuangChat2() {
      this.$nextTick(()=>{
        ...
        var caiwuqingkuangChart2 = echarts.init(document.getElementById("caiwuqingkuangChart2"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                caiwuqingkuangChart2.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    caiwuqingkuangChart2.resize();
                };
            }
        });
      })
    ...
    caiwuqingkuangChat3() {
      this.$nextTick(()=>{
        ...
        var caiwuqingkuangChart3 = echarts.init(document.getElementById("caiwuqingkuangChart3"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                caiwuqingkuangChart3.setOption(option);
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    caiwuqingkuangChart3.resize();
                };
            }
        });
      })
    ...
    caiwuqingkuangChat4() {
      this.$nextTick(()=>{
        ...
        var caiwuqingkuangChart4 = echarts.init(document.getElementById("caiwuqingkuangChart4"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                caiwuqingkuangChart4.setOption(option);

                  //根据窗口的大小变动图表
                window.onresize = function() {
                    caiwuqingkuangChart4.resize();
                };
            }
        });
      })
