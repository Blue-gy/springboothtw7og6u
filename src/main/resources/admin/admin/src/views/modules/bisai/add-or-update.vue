<template>
	<div class="addEdit-block" :style='{"width":"100%","padding":"50px 0 30px 0","margin":"0","overflow-y":"auto","background":"#fff","height":"auto"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="赛事名称" prop="saishimingcheng">
					<el-input v-model="ruleForm.saishimingcheng" placeholder="赛事名称" clearable  :readonly="ro.saishimingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="赛事名称" prop="saishimingcheng">
					<el-input v-model="ruleForm.saishimingcheng" placeholder="赛事名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="比赛时间" prop="bisaishijian">
					<el-input v-model="ruleForm.bisaishijian" placeholder="比赛时间" clearable  :readonly="ro.bisaishijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="比赛时间" prop="bisaishijian">
					<el-input v-model="ruleForm.bisaishijian" placeholder="比赛时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="比赛地点" prop="bisaididian">
					<el-input v-model="ruleForm.bisaididian" placeholder="比赛地点" clearable  :readonly="ro.bisaididian"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="比赛地点" prop="bisaididian">
					<el-input v-model="ruleForm.bisaididian" placeholder="比赛地点" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.bisaitupian" label="比赛图片" prop="bisaitupian">
					<file-upload
						tip="点击上传比赛图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.bisaitupian" label="比赛图片" prop="bisaitupian">
