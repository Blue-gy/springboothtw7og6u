	...
	<div class="addEdit-block" :style='{"width":"100%","padding":"50px 0 30px 0","margin":"0","overflow-y":"auto","background":"#fff","height":"auto"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.changditupian" label="场地图片" prop="changditupian">
					<file-upload
						tip="点击上传场地图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.changditupian" label="场地图片" prop="changditupian">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="场地地址" prop="changdidizhi">
					<el-input v-model="ruleForm.changdidizhi" placeholder="场地地址" clearable  :readonly="ro.changdidizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="场地地址" prop="changdidizhi">
					<el-input v-model="ruleForm.changdidizhi" placeholder="场地地址" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="场地余位" prop="renshuxianzhi">
					<el-input-number v-model="ruleForm.renshuxianzhi" placeholder="场地余位" :min="0" :readonly="ro.renshuxianzhi"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="场地余位" prop="renshuxianzhi">
					<el-input v-model="ruleForm.renshuxianzhi" placeholder="场地余位" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="场地介绍" prop="changdijieshao">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.changdijieshao" label="场地介绍" prop="changdijieshao">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.changdijieshao}}</span>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="场地设施" prop="changdisheshi">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.changdisheshi" label="场地设施" prop="changdisheshi">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.changdisheshi}}</span>
				</el-form-item>
