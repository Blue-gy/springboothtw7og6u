	...
	<div class="addEdit-block" :style='{"width":"100%","padding":"50px 0 30px 0","margin":"0","overflow-y":"auto","background":"#fff","height":"auto"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="场地介绍" prop="changdijieshao">
					<el-input v-model="ruleForm.changdijieshao" placeholder="场地介绍" clearable  :readonly="ro.changdijieshao"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="场地介绍" prop="changdijieshao">
					<el-input v-model="ruleForm.changdijieshao" placeholder="场地介绍" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="场地设施" prop="changdisheshi">
					<el-input v-model="ruleForm.changdisheshi" placeholder="场地设施" clearable  :readonly="ro.changdisheshi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="场地设施" prop="changdisheshi">
					<el-input v-model="ruleForm.changdisheshi" placeholder="场地设施" readonly></el-input>
				</el-form-item>
