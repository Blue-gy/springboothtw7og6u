	...
	<div class="addEdit-block" :style='{"width":"100%","padding":"50px 0 30px 0","margin":"0","overflow-y":"auto","background":"#fff","height":"auto"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="课程难度" prop="kechengnandu">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="课程难度" prop="kechengnandu">
					<el-input v-model="ruleForm.kechengnandu"
						placeholder="课程难度" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="适合人群" prop="shiherenqun">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="适合人群" prop="shiherenqun">
					<el-input v-model="ruleForm.shiherenqun"
						placeholder="适合人群" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="教练" prop="jiaolian">
					<el-input v-model="ruleForm.jiaolian" placeholder="教练" clearable  :readonly="ro.jiaolian"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="教练" prop="jiaolian">
					<el-input v-model="ruleForm.jiaolian" placeholder="教练" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="上课时间" prop="shangkeshijian">
					<el-input v-model="ruleForm.shangkeshijian" placeholder="上课时间" clearable  :readonly="ro.shangkeshijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="上课时间" prop="shangkeshijian">
					<el-input v-model="ruleForm.shangkeshijian" placeholder="上课时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="上课地点" prop="shangkedidian">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.kechengjianjie" label="课程简介" prop="kechengjianjie">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.kechengjianjie}}</span>
				</el-form-item>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jiaolian'){
							this.ruleForm.jiaolian = obj[o];
							this.ro.jiaolian = true;
							continue;
						}
						if(o=='kechengtupian'){
