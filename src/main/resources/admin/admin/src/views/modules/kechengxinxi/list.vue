		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 0 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"display":"block"}' >
					...
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}' class="select" label="课程难度" prop="kechengnandu">
						...
						<el-select clearable v-model="searchForm.kechengnandu" placeholder="请选择课程难度" >
							<el-option v-for="(item,index) in kechengnanduOptions" v-bind:key="index" :label="item" :value="item"></el-option>
						</el-select>
					</div>
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}' class="select" label="适合人群" prop="shiherenqun">
						...
						<el-select clearable v-model="searchForm.shiherenqun" placeholder="请选择适合人群" >
							<el-option v-for="(item,index) in shiherenqunOptions" v-bind:key="index" :label="item" :value="item"></el-option>
						</el-select>
					</div>
			...
			<div :style='{"width":"100%","padding":"10px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='false'
						...
						label="人数限制">
						<template slot-scope="scope">
							{{scope.row.renshuxianzhi ? scope.row.renshuxianzhi : '不限'}}
						</template>
					</el-table-column>
					<el-table-column :resizable='true' :sortable='false'
						prop="yiyuyuerenshu"
						label="已预约">
						<template slot-scope="scope">
							{{scope.row.yiyuyuerenshu ? scope.row.yiyuyuerenshu : 0}}
						</template>
					</el-table-column>
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('kechengxinxi','课程预约')" @click="kechengyuyueCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"rgb(139, 154, 179)","height":"40px"}'></span>
								课程预约
							</el-button>
...
import kechengyuyueCrossAddOrUpdate from "../kechengyuyue/add-or-update";
    ...
    init () {
          this.kechengnanduOptions = "低,中,高".split(',')
          this.shiherenqunOptions = "初学者,中级者,高级者".split(',')
    },
    search() {
      this.pageIndex = 1;
      this.getDataList();
