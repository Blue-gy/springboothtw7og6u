  ...
  <!-- 列表页 -->
    <template v-if="showFlag">
      <el-form class="center-form-pv"
               :style='{"margin":"0 0 20px"}' :inline="true"
               :model="searchForm">
        <el-row :style='{"display":"block"}'>
          <div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
            <label
               :style='{"margin":"0 10px 0 0","color":"#666","display":"none","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}'
                class="item-label">订单编号</label>
            <el-input v-model="searchForm.orderid" placeholder="订单编号" clearable></el-input>
          </div>
          <div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
            <label
               :style='{"margin":"0 10px 0 0","color":"#666","display":"none","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}'
                class="item-label">商品名称</label>
        ...
        <el-row :style='{"width":"170px","margin":"10px 0 0","flexDirection":"column","display":"flex"}'>
          <el-button
              :style='{"margin":"0 2px","fontSize":"14px","color":"#8a99b2","height":"40px"}'
              v-if="isAuth('orders'+'/'+orderStatus,'新增')" type="success" @click="addOrUpdateHandler()">新增
          </el-button>
          <el-button
              :style='{"margin":"0 2px","fontSize":"14px","color":"#8a99b2","height":"40px"}'
              v-if="isAuth('orders'+'/'+orderStatus,'删除')" :disabled="dataListSelections.length <= 0" type="danger"
          ...
          <el-button
              :style='{"margin":"0 2px","fontSize":"14px","color":"#8a99b2","height":"40px"}'
              v-if="isAuth('orders'+'/'+orderStatus,'日销量')" type="warning" @click="dayNumberChartDialog()">日销量
          </el-button>

          <el-button
              :style='{"margin":"0 2px","fontSize":"14px","color":"#8a99b2","height":"40px"}'
              v-if="isAuth('orders'+'/'+orderStatus,'月销量')" type="warning" @click="monthNumberChartDialog()">月销量
          </el-button>

          <el-button
              :style='{"margin":"0 2px","fontSize":"14px","color":"#8a99b2","height":"40px"}'
              v-if="isAuth('orders'+'/'+orderStatus,'年销量')" type="warning" @click="yearNumberChartDialog()">年销量
          </el-button>

          <el-button
              :style='{"margin":"0 2px","fontSize":"14px","color":"#8a99b2","height":"40px"}'
              v-if="isAuth('orders'+'/'+orderStatus,'品销量')" type="warning" @click="goodnameNumberChartDialog()">商品销量
          </el-button>

          <el-button
              :style='{"margin":"0 2px","fontSize":"14px","color":"#8a99b2","height":"40px"}'
              v-if="isAuth('orders'+'/'+orderStatus,'类销量')" type="warning" @click="goodtypeNumberChartDialog()">类型销量
          </el-button>

          <el-button
              :style='{"margin":"0 2px","fontSize":"14px","color":"#8a99b2","height":"40px"}'
              v-if="isAuth('orders'+'/'+orderStatus,'日销额')" type="warning" @click="dayAmountChartDialog()">日销额
          </el-button>

          <el-button
              :style='{"margin":"0 2px","fontSize":"14px","color":"#8a99b2","height":"40px"}'
              v-if="isAuth('orders'+'/'+orderStatus,'月销额')" type="warning" @click="monthAmountChartDialog()">月销额
          </el-button>

          <el-button
              :style='{"margin":"0 2px","fontSize":"14px","color":"#8a99b2","height":"40px"}'
              v-if="isAuth('orders'+'/'+orderStatus,'年销额')" type="warning" @click="yearAmountChartDialog()">年销额
          </el-button>

          <el-button
              :style='{"margin":"0 2px","fontSize":"14px","color":"#8a99b2","height":"40px"}'
              v-if="isAuth('orders'+'/'+orderStatus,'品销额')" type="warning" @click="goodnameAmountChartDialog()">商品销额
          </el-button>

          <el-button
              :style='{"margin":"0 2px","fontSize":"14px","color":"#8a99b2","height":"40px"}'
              v-if="isAuth('orders'+'/'+orderStatus,'类销额')" type="warning" @click="goodtypeAmountChartDialog()">类型销额
          </el-button>
        </el-row>
      </el-form>
        ...
        <el-table-column :resizable='true' :sortable='false' prop="picture" width="200" label="商品图片">
          <template slot-scope="scope">
            <div v-if="scope.row.picture">
              <img v-if="scope.row.picture.substring(0,4)=='http'" :src="scope.row.picture.split(',')[0]" width="100"
                   height="100">
        ...
        <el-table-column width="300" label="操作">
          <template slot-scope="scope">
            <el-button
                ...
                v-if=" isAuth('orders'+'/'+orderStatus,'查看')" type="success" size="mini"
                @click="addOrUpdateHandler(scope.row.id,'info')">详情
            </el-button>
            <el-button
                :style='{"border":"1px solid rgba(135, 154, 108, 1)","cursor":"pointer","padding":"0 10px","margin":"0 10px 5px 0","outline":"none","color":"rgba(135, 154, 108, 1)","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}'
                v-if=" isAuth('orders'+'/'+orderStatus,'修改')" type="primary" size="mini"
                @click="addOrUpdateHandler(scope.row.id)">修改
            </el-button>

            <el-button
                :style='{"border":"1px solid rgba(135, 154, 108, 1)","cursor":"pointer","padding":"0 10px","margin":"0 10px 5px 0","outline":"none","color":"rgba(135, 154, 108, 1)","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}'
                v-if="isAuth('orders'+'/'+orderStatus,'核销')" type="primary" size="mini" @click="writeOff(scope.row)">
              核销
            </el-button>
            ...
            <el-button
                :style='{"border":"1px solid rgba(135, 154, 108, 1)","cursor":"pointer","padding":"0 10px","margin":"0 10px 5px 0","outline":"none","color":"rgba(135, 154, 108, 1)","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}'
                v-if="isAuth('orders'+'/'+orderStatus,'删除') " type="danger" size="mini"
