  ...
  <!-- 列表页 -->
    <template v-if="showFlag">
      <el-form class="center-form-pv"
        ...
        <el-row :style='{"flexWrap":"wrap","margin":"20px 0","display":"flex"}'>
          <el-button
              :style='{"margin":"0 2px","fontSize":"14px","color":"#8a99b2","height":"40px"}'
              v-if="isAuth('shangpinxinxi','新增')" type="success" @click="addOrUpdateHandler()">新增
          </el-button>
          <el-button
              :style='{"margin":"0 2px","fontSize":"14px","color":"#8a99b2","height":"40px"}'
              v-if="isAuth('shangpinxinxi','删除')" :disabled="dataListSelections.length <= 0" type="danger"
          ...
          <el-button
              :style='{"margin":"0 2px","fontSize":"14px","color":"#8a99b2","height":"40px"}'
              v-if="isAuth('shangpinxinxi','商品分类统计')" type="warning" @click="chartDialog1()">商品分类统计
          </el-button>
          <el-button
              :style='{"margin":"0 2px","fontSize":"14px","color":"#8a99b2","height":"40px"}'
              v-if="isAuth('shangpinxinxi','商品库存统计')" type="warning" @click="chartDialog2()">商品库存统计
          </el-button>
        </el-row>
      </el-form>
        ...
        <el-table-column :resizable='true' :sortable='false' prop="shangpintupian" width="200" label="商品图片">
          <template slot-scope="scope">
            <div v-if="scope.row.shangpintupian">
              <img v-if="scope.row.shangpintupian.substring(0,4)=='http'" :src="scope.row.shangpintupian.split(',')[0]"
        ...
        <el-table-column width="300" label="操作">
          <template slot-scope="scope">
            <el-button
                ...
                v-if=" isAuth('shangpinxinxi','查看')" type="success" size="mini"
                @click="addOrUpdateHandler(scope.row.id,'info')">详情
            </el-button>
            <el-button
                :style='{"border":"1px solid rgba(135, 154, 108, 1)","cursor":"pointer","padding":"0 10px","margin":"0 10px 5px 0","outline":"none","color":"rgba(135, 154, 108, 1)","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}'
                v-if=" isAuth('shangpinxinxi','修改')" type="primary" size="mini"
            ...
            <el-button
                :style='{"border":"1px solid rgba(135, 154, 108, 1)","cursor":"pointer","padding":"0 10px","margin":"0 10px 5px 0","outline":"none","color":"rgba(135, 154, 108, 1)","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}'
                v-if="isAuth('shangpinxinxi','查看评论')" type="primary" size="mini"
            ...
            <el-button
                :style='{"border":"1px solid rgba(135, 154, 108, 1)","cursor":"pointer","padding":"0 10px","margin":"0 10px 5px 0","outline":"none","color":"rgba(135, 154, 108, 1)","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}'
                v-if="isAuth('shangpinxinxi','删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">删除
            </el-button>
          </template>
        </el-table-column>
      </el-table>
