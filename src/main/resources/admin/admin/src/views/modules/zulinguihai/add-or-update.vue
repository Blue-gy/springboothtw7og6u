	...
	<div class="addEdit-block" :style='{"width":"100%","padding":"50px 0 30px 0","margin":"0","overflow-y":"auto","background":"#fff","height":"auto"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="归还数量" prop="kucunshuliang">
					<el-input v-model.number="ruleForm.kucunshuliang" placeholder="归还数量" clearable  :readonly="ro.kucunshuliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="归还数量" prop="kucunshuliang">
					<el-input v-model="ruleForm.kucunshuliang" placeholder="归还数量" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.shebeitupian" label="设备图片" prop="shebeitupian">
					<file-upload
						tip="点击上传设备图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.shebeitupian" label="设备图片" prop="shebeitupian">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="设备简介" prop="shebeijianjie">
					<el-input v-model="ruleForm.shebeijianjie" placeholder="设备简介" clearable  :readonly="ro.shebeijianjie"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="设备简介" prop="shebeijianjie">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="租赁金额" prop="zulinjine">
					<el-input v-model.number="ruleForm.zulinjine" placeholder="租赁金额" clearable  :readonly="ro.zulinjine"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="租赁金额" prop="zulinjine">
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `zulinguihai/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.zulinguihaiCrossAddOrUpdateFlag = false;
											this.parent.search();
